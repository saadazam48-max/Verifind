...
const RESTAURANTS = [
  ...
  { id:64, name:"E Pellicci",               cuisine:"Italian",      rating:4.6, price:1, reviews:2890, address:"332 Bethnal Green Rd, E2",         certified:false, tags:["Italian","Cafe","Breakfast","Iconic","East London"],             dishes:["Full English","Carbonara","Lasagne","Tiramisu","Espresso"],             emoji:"☕", x:78, y:35, instagram:"epellicci",                 igFollowers:"19K",   lat:51.5271, lng:-0.0706 },
  ...
  { id:70, name:"St John Bread & Wine",     cuisine:"British",      rating:4.6, price:3, reviews:1980, address:"94-96 Commercial St, Spitalfields",certified:false, tags:["British","Nose to Tail","Wine","Brunch","Iconic"],               dishes:["Bone Marrow","Welsh Rarebit","Eccles Cake","Roast Bone Marrow"],       emoji:"🍷", x:79, y:40, instagram:"stjohnrestaurant",           igFollowers:"38K",   lat:51.5192, lng:-0.0745 },
  ...
  { id:76, name:"Bubala",                   cuisine:"Israeli",      rating:4.7, price:2, reviews:2100, address:"65 Commercial St, Spitalfields",  certified:false, tags:["Israeli","Vegetarian","Mezze","Trendy","Brunch"],                dishes:["Hummus","Falafel","Shakshuka","Knafeh","Halloumi"],                     emoji:"🌿", x:79, y:41, instagram:"bubala_london", igFollowers:"67K",  lat:51.5193, lng:-0.0748 },
  ...
  { id:79, name:"Mildreds",                 cuisine:"Vegetarian",   rating:4.5, price:2, reviews:4100, address:"45 Lexington St, Soho",           certified:false, tags:["Vegetarian","Vegan","Healthy","Casual","International"],         dishes:["Veggie Burger","Mezze Plate","Sri Lankan Curry","Tofu Bowl"],           emoji:"🥗", x:59, y:46, instagram:"mildreds_restaurant", igFollowers:"41K", lat:51.5133, lng:-0.1338 },
  ...
  // ── More East London ──
  { id:81, name:"Lyle's",                   cuisine:"British",      rating:4.8, price:4, reviews:1980, address:"Tea Building, 56 Shoreditch High St", certified:false, tags:["British","Seasonal","Fine Dining","Award-Winning","Lunch"],   dishes:["Seasonal Set Menu","Brown Crab","Meadowsweet Ice Cream"],              emoji:"🌿", x:79, y:33, instagram:"lyleslondon",   igFollowers:"34K",  lat:51.5246, lng:-0.0786 },
  { id:82, name:"Padella",                  cuisine:"Italian",      rating:4.7, price:1, reviews:5600, address:"6 Southwark St, Borough",         certified:false, tags:["Pasta","Budget","Queue","Italian","Fresh"],                      dishes:["Pici Cacio e Pepe","Tajarin","Burrata","Tiramisu"],                     emoji:"🍝", x:68, y:52, instagram:"padellalondon", igFollowers:"118K", lat:51.5043, lng:-0.0907 },
  { id:83, name:"Monty's Deli",             cuisine:"Jewish Deli",  rating:4.6, price:2, reviews:1540, address:"227 Hoxton St, N1",               certified:false, tags:["Deli","Pastrami","Bagel","Brunch","Casual"],                     dishes:["Salt Beef Bagel","Pastrami on Rye","Latkes","Pickle","Cheesecake"],    emoji:"🥪", x:74, y:24, instagram:"montysdeli",    igFollowers:"22K",  lat:51.5352, lng:-0.0813 },
  { id:84, name:"Towpath Cafe",             cuisine:"Cafe",         rating:4.6, price:1, reviews:1230, address:"Regent's Canal, De Beauvoir",     certified:false, tags:["Cafe","Brunch","Canal","Seasonal","Relaxed"],                    dishes:["Eggs on Toast","Soup","Pastries","Coffee","Seasonal Special"],          emoji:"☕", x:74, y:22, instagram:"towpathcafe",   igFollowers:"19K",  lat:51.5393, lng:-0.0851 },
  { id:85, name:"Sager + Wilde",            cuisine:"Wine Bar",     rating:4.5, price:2, reviews:1450, address:"193 Hackney Rd, E2",              certified:false, tags:["Wine","Small Plates","Cheese","Casual","Neighbourhood"],         dishes:["Cheese Board","Charcuterie","Seasonal Plates","Natural Wine"],          emoji:"🍷", x:76, y:30, instagram:"sagerandwilde", igFollowers:"16K",  lat:51.5309, lng:-0.0763 },
  { id:86, name:"Brawn",                    cuisine:"French",       rating:4.6, price:3, reviews:1870, address:"49 Columbia Rd, E2",              certified:false, tags:["French","Wine","Seasonal","Neighbourhood","Relaxed"],            dishes:["Charcuterie","Duck Confit","Crème Brûlée","Natural Wine"],              emoji:"🇫🇷", x:77, y:31, instagram:"brawnlondon",  igFollowers:"11K",  lat:51.5292, lng:-0.0742 },
  { id:87, name:"Brat",                     cuisine:"Basque",       rating:4.8, price:4, reviews:2100, address:"4 Redchurch St, Shoreditch",      certified:false, tags:["Basque","Turbot","Fire","Fine Dining","Award-Winning"],          dishes:["Whole Turbot","Txuleta Steak","Anchovies","Wood-Fired Bread"],         emoji:"🐟", x:78, y:35, instagram:"bratrestaurant", igFollowers:"47K",  lat:51.5234, lng:-0.0775 },
  ...
  { id:90, name:"Clove Club",               cuisine:"British",      rating:4.9, price:4, reviews:2800, address:"Shoreditch Town Hall, 380 Old St", certified:false, tags:["Fine Dining","British","Tasting Menu","Award-Winning","Special Occasion"], dishes:["Tasting Menu","Buttermilk Chicken","Pine Salt Beef Tartare"],    emoji:"⭐", x:78, y:34, instagram:"thecloveclub", igFollowers:"62K",  lat:51.5268, lng:-0.0849 },

  // ── North & Additional Central ──
  { id:91, name:"Ottolenghi Islington",     cuisine:"Mediterranean",rating:4.6, price:2, reviews:3870, address:"287 Upper St, Islington",        certified:false, tags:["Brunch","Vegetarian","Mediterranean","Salads","Bakery"],         dishes:["Eggs Shakshuka","Roasted Veg","Knafeh","Cardamom Bun"],                emoji:"🥐", x:66, y:19, instagram:"ottolenghi",    igFollowers:"892K", lat:51.5390, lng:-0.1025 },
  { id:92, name:"Trullo",                   cuisine:"Italian",      rating:4.7, price:3, reviews:2100, address:"300 St Paul's Rd, Highbury",      certified:false, tags:["Italian","Pasta","Neighbourhood","Wine","Date Night"],           dishes:["Pappardelle","Tagliarini","Panna Cotta","Burrata","Tiramisu"],          emoji:"🍝", x:65, y:15, instagram:"trullolondon",  igFollowers:"22K",  lat:51.5493, lng:-0.1001 },
  { id:93, name:"Caravan King's Cross",     cuisine:"International",rating:4.5, price:2, reviews:4200, address:"1 Granary Sq, King's Cross",      certified:false, tags:["Brunch","Coffee","International","Casual","All Day"],            dishes:["Sweetcorn Fritters","Eggs Benedict","Flat White","Granola"],            emoji:"☕", x:62, y:28, instagram:"caravankx",     igFollowers:"67K",  lat:51.5354, lng:-0.1244 },
  { id:94, name:"Barrafina",                cuisine:"Spanish",      rating:4.7, price:3, reviews:3400, address:"54 Frith St, Soho",               certified:false, tags:["Spanish","Tapas","Counter","Queue","Seafood"],                   dishes:["Tortilla","Gambas al Ajillo","Croquetas","Patatas Bravas"],             emoji:"🇪🇸", x:59, y:45, instagram:"barrafina_",   igFollowers:"38K",  lat:51.5133, lng:-0.1319 },
  { id:95, name:"Quo Vadis",                cuisine:"British",      rating:4.6, price:3, reviews:1870, address:"26-29 Dean St, Soho",             certified:false, tags:["British","Soho","Classic","Members Club","Date Night"],          dishes:["Dover Sole","Haddock Chowder","Steak Tartare","Sticky Toffee"],        emoji:"🎭", x:59, y:45, instagram:"quovadissoho",  igFollowers:"14K",  lat:51.5135, lng:-0.1316 },
  ...
  { id:100,name:"Naughty Piglets",          cuisine:"Wine Bar",     rating:4.6, price:2, reviews:1230, address:"28 Brixton Water Lane, SW2",      certified:false, tags:["Wine","Small Plates","Neighbourhood","Creative","Casual"],       dishes:["Natural Wine","Seasonal Plates","Cheese","Charcuterie"],               emoji:"🍷", x:55, y:80, instagram:"naughtypiglets", igFollowers:"9.1K", lat:51.4589, lng:-0.1131 },
  { id:101,name:"Four Legs at The Compton", cuisine:"British",      rating:4.6, price:2, reviews:980,  address:"4 Compton Ave, Islington",        certified:false, tags:["British","Pub","Burger","Neighbourhood","Casual"],               dishes:["The Compton Cheeseburger","Chips","Anchovy Toast","Crumble"],           emoji:"🍔", x:66, y:20, instagram:"fourlegsatthecompton", igFollowers:"12K", lat:51.5440, lng:-0.1041 },
  ...
  { id:114,name:"Zia Lucia",                cuisine:"Pizza",        rating:4.7, price:2, reviews:2870, address:"157 Holloway Rd, N7",              certified:false, tags:["Pizza","Charcoal","Trendy","Date Night","Italian"],              dishes:["Charcoal Dough Pizza","Nduja","Burrata","Tiramisu"],                   emoji:"🍕", x:62, y:17, instagram:"zialucia",          igFollowers:"89K",  lat:51.5538, lng:-0.1157 },
  ...
  { id:117,name:"Vrisaki",                  cuisine:"Greek/Turkish",rating:4.6, price:2, reviews:1870, address:"73 Myddleton Rd, Bounds Green",   certified:false, tags:["Greek","Turkish","Mezze","Family","Casual"],                     dishes:["Mixed Mezze","Souvlaki","Halloumi","Baklava","Hummus"],                emoji:"🏺", x:58, y:8,  instagram:"vrisaki",           igFollowers:"3.4K", lat:51.5990, lng:-0.1123 },
  ...
  { id:120,name:"Camden Market Food Hall",  cuisine:"International",rating:4.4, price:1, reviews:8900, address:"Camden Lock Market, NW1",          certified:false, tags:["Street Food","Market","International","Casual","Varied"],         dishes:["Various Street Food","Ethiopian","Jerk Chicken","Falafel","Crepes"],   emoji:"🌍", x:57, y:19, instagram:"camdenmarket",      igFollowers:"412K", lat:51.5439, lng:-0.1466 },
  ...
  // ── South London ──
  { id:151,name:"Kudu",                     cuisine:"South African",rating:4.7, price:3, reviews:1870, address:"119 Queen's Rd, Peckham",          certified:false, tags:["South African","Creative","Date Night","Trendy","Peckham"],      dishes:["Beef Brisket","Bobotie","Boerewors","Malva Pudding"],                  emoji:"🌍", x:68, y:78, instagram:"kudupeckham",       igFollowers:"22K",  lat:51.4734, lng:-0.0672 },
  ...
  { id:153,name:"Tooting Market",           cuisine:"International",rating:4.5, price:1, reviews:3400, address:"21-23 Tooting High St, SW17",      certified:false, tags:["Street Food","Market","International","Casual","Varied"],         dishes:["Various","Sri Lankan","Jerk","Pizza","Craft Beer"],                    emoji:"🌍", x:50, y:85, instagram:"tootingmarket",     igFollowers:"18K",  lat:51.4273, lng:-0.1680 },
  ...
  { id:156,name:"Honest Burgers Brixton",   cuisine:"Burgers",      rating:4.6, price:2, reviews:3870, address:"Unit 12, Brixton Village",         certified:true,  tags:["Burger","Brixton","Casual","Craft Beer","Rosemary Chips"],       dishes:["Honest Burger","Tribute Burger","Rosemary Chips","Chocolate Sundae"],  emoji:"🍔", x:55, y:79, instagram:"honestburgers",     igFollowers:"87K",  lat:51.4627, lng:-0.1146 },
